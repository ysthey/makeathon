...
package org.makeathon.telepresenceslave.roboliterate.activities;
...
//
       ...
       // set up Left Motor Spinner
        ...
        leftMotorSpinner.setOnItemSelectedListener(new OnMotorPortSelectedListener(Robot.Motor.LEFT));
        leftMotorSpinner.setSelection(mMotorPortList.indexOf(Robot.Motor.LEFT.getPort()));
...
//
        ...
        rightMotorSpinner.setOnItemSelectedListener(new OnMotorPortSelectedListener(Robot.Motor.RIGHT));
        rightMotorSpinner.setSelection(mMotorPortList.indexOf(Robot.Motor.RIGHT.getPort()));
