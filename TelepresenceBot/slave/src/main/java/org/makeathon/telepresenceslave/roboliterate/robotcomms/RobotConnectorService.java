        ...
        public void handleMessage(Message message) {
            ...
            switch (message.what) {
                ...
                case MSG_EXECUTE_PROGRAM:
                    switch (message.arg1) {
                        case Commander.STATUS_INITIATING:
...
//        mCommander.doRobotStopSounds();
    ...
    public void onCommunicationFailure(int status) {
        notifyClients(MSG_CONNECT_TO_ROBOT, Commander.STATUS_CONNECTIONERROR,0);
    ...
    public void onProgramLineExecuted(int status) {
        notifyClients(MSG_EXECUTE_PROGRAM, Commander.STATUS_RUNNING, status);
    }
    ...
    public void onProgramComplete(int status) {
        notifyClients(MSG_EXECUTE_PROGRAM, Commander.STATUS_COMPLETE, 0);
    }

    @Override
    public void onPortsDetected(int status) {
        notifyClients(MSG_DETECT_SENSORPORTS, Commander.STATUS_COMPLETE, 0);
    }
            ...
            public void run() {
                ...
                try {
                    ...
                    try {
                        ...
                        if (isPairing) {
                            notifyClients(MSG_CONNECT_TO_ROBOT, Commander.STATUS_CONNECTIONERROR_PAIRING, 0);
                            return;
                        }
              ...
              //  RobotType = (robotType.startsWith("EV3") ? Robot.MODEL_EV3 : Robot.MODEL_NXT);
                ...
                notifyClients(MSG_CONNECT_TO_ROBOT, Commander.STATUS_OK,0);
